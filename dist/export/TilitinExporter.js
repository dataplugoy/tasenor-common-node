...
exports.TilitinExporter = void 0;
...
const ACCOUNT_TYPES = Object.keys(tasenor_common_1.AccountType);
// Helpers to convert nasty dates from original format.
function dateFromDb(date) {
    const str = dayjs_1.default.utc(date).add(2, 'hours').format('YYYY-MM-DD');
    return str;
}
/**
 * A class implementing conversion from old legacy Tilitin Sqlite-format to Tasenor format.
 */
class TilitinExporter extends Exporter_1.Exporter {
    /**
    ...
    async getReports(db) {
        ...
        (0, tasenor_common_1.log)(`Found reports ${Object.keys(reports)}.`);
        return reports;
    }
    /**
    ...
    async run(sqlite, out, destPath) {
        if (!fs_1.default.existsSync(sqlite)) {
...
exports.TilitinExporter = TilitinExporter;
