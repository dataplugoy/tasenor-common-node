...
var require_errno = __commonJS({
  "node_modules/fast-glob/out/utils/errno.js"(exports) {
    ...
    function isEnoentCodeError(error8) {
      return error8.code === "ENOENT";
    }
  ...
  "node_modules/fast-glob/out/utils/stream.js"(exports) {
    ...
    function merge3(streams) {
      ...
      streams.forEach((stream) => {
        stream.once("error", (error8) => mergedStream.emit("error", error8));
      });
...
var require_async = __commonJS({
  "node_modules/@nodelib/fs.stat/out/providers/async.js"(exports) {
    ...
    exports.read = read;
    function callFailureCallback(callback, error8) {
      callback(error8);
    }
...
var require_common2 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/readers/common.js"(exports) {
    ...
    function isFatalError(settings, error8) {
      if (settings.errorFilter === null) {
        return true;
      }
      return !settings.errorFilter(error8);
    }
  ...
  "node_modules/@nodelib/fs.walk/out/readers/async.js"(exports) {
    ...
    var AsyncReader = class extends reader_1.default {
      ...
      _pushToQueue(directory, base) {
        ...
        this._queue.push(queueItem, (error8) => {
          if (error8 !== null) {
            this._handleError(error8);
          }
        });
      }
      _worker(item, done) {
        this._scandir(item.directory, this._settings.fsScandirSettings, (error8, entries) => {
          if (error8 !== null) {
            done(error8, void 0);
            return;
          }
      ...
      _handleError(error8) {
        if (this._isDestroyed || !common.isFatalError(this._settings, error8)) {
          return;
        }
        this._isFatalError = true;
        this._isDestroyed = true;
        this._emitter.emit("error", error8);
      }
...
var require_async4 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/providers/async.js"(exports) {
    ...
    var AsyncProvider = class {
      ...
      read(callback) {
        this._reader.onError((error8) => {
          callFailureCallback(callback, error8);
        });
...
var require_stream2 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/providers/stream.js"(exports) {
    ...
    var StreamProvider = class {
      ...
      read() {
        this._reader.onError((error8) => {
          this._stream.emit("error", error8);
        });
        this._reader.onEntry((entry) => {
...
var require_sync3 = __commonJS({
  "node_modules/@nodelib/fs.walk/out/readers/sync.js"(exports) {
    ...
    var SyncReader = class extends reader_1.default {
      ...
      _handleError(error8) {
        if (!common.isFatalError(this._settings, error8)) {
          return;
        }
        throw error8;
      }
...
var require_reader2 = __commonJS({
  "node_modules/fast-glob/out/readers/reader.js"(exports) {
    ...
    var Reader = class {
      ...
      _isFatalError(error8) {
        return !utils.errno.isEnoentCodeError(error8) && !this._settings.suppressErrors;
      }
    };
    exports.default = Reader;
  }
  ...
  "node_modules/fast-glob/out/readers/stream.js"(exports) {
    ...
    var ReaderStream = class extends reader_1.default {
      ...
      _getEntry(filepath, pattern, options) {
        return this._getStat(filepath).then((stats) => this._makeEntry(stats, pattern)).catch((error8) => {
          if (options.errorFilter(error8)) {
            return null;
          }
          throw error8;
        });
      ...
      _getStat(filepath) {
        return new Promise((resolve, reject) => {
          this._stat(filepath, this._fsStatSettings, (error8, stats) => {
            return error8 === null ? resolve(stats) : reject(error8);
          });
        });
      }
    };
...
var require_async5 = __commonJS({
  "node_modules/fast-glob/out/readers/async.js"(exports) {
    ...
    var ReaderAsync = class extends reader_1.default {
      ...
      dynamic(root, options) {
        return new Promise((resolve, reject) => {
          this._walkAsync(root, options, (error8, entries) => {
            if (error8 === null) {
              resolve(entries);
            } else {
              reject(error8);
...
var require_error = __commonJS({
  "node_modules/fast-glob/out/providers/filters/error.js"(exports) {
    ...
    var ErrorFilter = class {
      ...
      getFilter() {
        return (error8) => this._isNonFatalError(error8);
      }
      _isNonFatalError(error8) {
        return utils.errno.isEnoentCodeError(error8) || this._settings.suppressErrors;
      }
    };
  ...
  "node_modules/fast-glob/out/providers/stream.js"(exports) {
    ...
    var ProviderStream = class extends provider_1.default {
      ...
      read(task) {
        ...
        source.once("error", (error8) => destination.emit("error", error8)).on("data", (entry) => destination.emit("data", options.transform(entry))).once("end", () => destination.emit("end"));
...
async function fetchOfficialPluginList() {
  const plugins2 = await import_tasenor_common30.net.GET(`${vault.get("TASENOR_API_URL")}/plugins`);
  if (plugins2.success) {
