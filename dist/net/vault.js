...
exports.vault = exports.getVault = exports.EnvironmentVault = exports.Vault = exports.ALLOWED_VAULT_VARIABLES = void 0;
const crypto_1 = require("./crypto");
exports.ALLOWED_VAULT_VARIABLES = [
    'TASENOR_API_URL',
    'API_SITE_TOKEN',
...
const validVariables = new Set(exports.ALLOWED_VAULT_VARIABLES);
/**
...
class Vault {
    ...
    getPrivateSecret() {
        if (this.secret === null) {
            this.secret = (0, crypto_1.randomString)(512);
        }
        return this.secret;
    }
    /**
 ...
 */
class EnvironmentVault extends Vault {
    async initialize() {
        for (const variable of exports.ALLOWED_VAULT_VARIABLES) {
...
exports.EnvironmentVault = EnvironmentVault;
/**
